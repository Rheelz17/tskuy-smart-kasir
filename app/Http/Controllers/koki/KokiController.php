...
class KokiController extends Controller
{
    public function index()
    {
        $rawOrders = DB::table('orders')
            ...
            ->where(function($query) {
                // LOGIKA 1: Sembunyikan "Pay Now" yang belum lunas
                // Koki cuma lihat pesanan Open Bill (1) ATAU Pay Now (0) yang sudah lunas (paid)
    ...
    {
        // Sesuaikan juga hitungan auto-refresh dengan logika yang sama
