@extends('layouts.koki') {{-- PERBAIKAN 1: Mengarah ke folder layouts global --}}
...
<div class="koki-app">
  ...
  ══════════════════════════════════════════════════════════════ --}}
  @include('partials.koki-filter') {{-- PERBAIKAN 2: Mengarah ke partials global, pastiin filenya ada di resources/views/partials/koki-filter.blade.php --}}
    ...
    <div class="orders-grid" id="ordersGrid">
      ...
      @forelse($orders as $order)
        @php
          ...
          // PERBAIKAN 3: Menghapus baris gado-gado duplikat yang ada typo $isDoneIn
