...
document.addEventListener("click", function (e) {
  ...
  if (opener) {
    ...
    // POS.js HANYA mengurusi popup detail menu atau warning login kasir
    if (targetId.startsWith("popup-detail-") || targetId === "popup-login-warning") {
        e.stopPropagation();
        e.stopImmediatePropagation(); // KUNCI: Hentikan listener lain di document agar tidak memicu klik ganda
    ...
    // Jika targetId adalah popup-notif-panel, script akan mengabaikannya di sini
    // dan membiarkan kasir-core.js mengeksekusinya secara tunggal.
  }
